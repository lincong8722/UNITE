...
for Parkinson's disease (PD). Notably, it is designed to be extendable
...
> somato-cognitive action network (SCAN). The 213-region atlas is an
...
> 
> **c)** UNITE allows for precise localization of functionally
