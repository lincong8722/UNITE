...
p.add_argument('-a2', '--apply2', type=str, metavar='APPLY_TRANS2')
p.add_argument('-a2o', '--apply2_out', type=str, metavar='APPLY_TRANS2_OUT')
...
## do the same for the second apply
if arg.apply2:
    apply_mov = sf.load_volume(arg.apply2)
    apply_out = transform(apply_mov, trans=vox_1, shape=fix.shape)
    apply_out = fix.new(apply_out)
    apply_out.save(arg.apply2_out)
